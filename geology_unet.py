...
class GeologyUNet(nn.Module):
    def __init__(self):
        ...
        self.bottleneck1 = self._block(512, 512)
        self.bottleneck2 = self._block(512, 512)
    ...
    def forward(self, x, t):
        ...
        bottleneck = self.bottleneck1(self.downsample(e4))
...
def train_geology_ddpm():
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 5 == 0:
            torch.save(model.state_dict(), f'/Home/siv36/hesal5042/Research/NORCE/hello/RePaint/guided_diffusion_mnist/guided_diffusion/Geology/Geology_Code/output/train_generated_patches_newUnet/model{epoch+1}.pth')
